(function () {
  ...
  function textProvider($hangul) {
    ...
    self.texts.en = {
      ...
      pokemonChart: 'Pokemon Charts',
      myPage: 'My Page',
      pokemonTips: 'Pokemon Tips',
      pokemonTipDetail: 'Tips',
      pokemonDicDetail: 'Pokedex Details',
      pokemonDic: 'Pokedex',
      ...
      orderPodex: "Pokedex Number",
      orderRare: "Rarity",
      orderMaxCp: "Max CP",
      orderPokemonPower: "Bast Stats",
      align: "Chnage Orders",
      loadingPokemon: "Loading... Pokemon Data",
      individualValue: "IV",
      pokemonPower: "Base Stats",
      pokemonPowerRank: "Base Stats Rank",
      wonderPokemonsRank: 'Select Pokemon',
      cpPokemon: "Select Pokemon",
      close: "Close",
      pokemonHatched: function (name) {
        return (name) + " hatches from egg.";
      },
      range: "Range",
      rangeTipSub: "", //나로부터 범위에 있는 팁을 읽습니다.
      rangeChange: "Range Change",
      tipAboutPokemon: "Tip About Pokemon",
      findTipMessage: function (name) {
        return "find " + name;
      },
      writeTip: "Write Tip",
      ...
      cancel: "Cancel",
      deleteMessage: "Delete Tips",
      deleteMessageSub: "Delete Tips",
      deleteMessageByName: function (name) {
        return "Are you sure Delete " + name;
      },
      messageWroteByName: function (name) {
        return name + " done";
      },
      ...
      reply: "Reply",
      strongAttack: " deals 1.25X damage",
      weakAttack: " deals 0.8X damage",
      typeAttack: " Type",
      ok: "OK",
      strongDefense: " attacks calculated 0.8X",
      weakDefense: " attacks calculated 1.25X",
      ...
      story: 'Story',
      maxLevel: 'MaxLevel',
      attackSkills: "All Moves",
      pokemonStatistics: "Pokemon Statistics",
      ratioInAllPokemon: "Pokemon Ratio",
      now1stPlaceCp: "1st Pokemon CP",
      averageCP: "Average CP",
      pokemonRankIsOrderByCp: "Pokemon Ranking By CP",
      trainerOrderBy6Cp: "Ranking By Best 6 Pokemon's CP",
      onesPokemon: "'s Pokemon",
      trainerLevel: 'Trainer\'s Level',
      reset: 'Reset',
      stronger: "Power UP",
      fromEggPokemons: 'Pokemons',
      twoKmAnd: '2KM And +',
      fiveKmAnd: '5KM And +',
      egg: 'Egg',
      time: "Time",
